// app/api/hubspot/tag-deal-lost/route.js
...
export async function POST(request) {
    try {
        ...
        console.log("Received HubSpot deal-lost webhook:", payload);
        ...
        // Tag ID for deal-lost users
        const DEAL_LOST_TAG_ID = "14931298";
        ...
        const result = await subscribeAndTag(email, DEAL_LOST_TAG_ID, apiSecret);
        ...
        console.error("Error processing HubSpot deal-lost webhook:", error);
        return NextResponse.json(
            {
                success: false,
